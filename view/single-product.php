			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="<?php echo $products['product_image'];?>" alt="">
						</div>
					</div>
				</div>
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2><?php echo $products['product_price'];?> VND </h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span><?php echo $products['product_category'];?></a></li>
							<li><a href="#"><span>Availibility</span> <?php echo $products['product_status'];?></a></li>
						</ul>
						...
						<a class="button primary-btn" href="cart.php?id_product=<?php echo $products['id_product'];?>">Add to Cart</a>  
						</div>
					</div>
				</div>
			</div>
