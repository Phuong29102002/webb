        ...
        <div class="row no-gutters align-items-center pt-60px">
          ...
          <div class="col-sm-7 col-lg-6 offset-lg-1 pl-4 pl-md-5 pl-lg-0">
            <div class="hero-banner__content">
              ...
              <p>Our store regularly updates the latest fashion trends to meet customer needs. 
                Guaranteed to provide quality products at reasonable prices.
                Providing diversity in clothing and accessory choices, suitable for many different styles and customers</p>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card text-center card-product">
              ...
              <div class="card-body">
                <p>Woman</p>
                <h4 class="card-product__title"><a href="single-product.php">CONTRAST SATIN BUSTIER</a></h4>
                <p class="card-product__price">1,599,000 VND</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card text-center card-product">
              ...
              <div class="card-body">
                <p>Woman</p>
                <h4 class="card-product__title"><a href="single-product.php">TAILORED DOUBLE-BREASTED BLAZER</a></h4>
                <p class="card-product__price">1,999,000 VND</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card text-center card-product">
              ...
              <div class="card-body">
                <p>Man</p>
                <h4 class="card-product__title"><a href="single-product.php">FADED KNIT T-SHIRT</a></h4>
                <p class="card-product__price">799,000 VND</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card text-center card-product">
              ...
              <div class="card-body">
                <p>Man</p>
                <h4 class="card-product__title"><a href="single-product.php">TEXTURED POLO SHIRT</a></h4>
                <p class="card-product__price">799,000 VND</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card text-center card-product">
              ...
              <div class="card-body">
                <p>Kid</p>
                <h4 class="card-product__title"><a href="single-product.php">ZIP-UP POLO DRESS</a></h4>
                <p class="card-product__price">729,000 VND</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card text-center card-product">
              ...
              <div class="card-body">
                <p>Kid</p>
                <h4 class="card-product__title"><a href="single-product.php">TEXTURED WRAP DRESS</a></h4>
                <p class="card-product__price">999,000 VND</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card text-center card-product">
              ...
              <div class="card-body">
                <p>Accessories</p>
                <h4 class="card-product__title"><a href="single-product.php">PRINTED CANVAS BAG</a></h4>
                <p class="card-product__price">999,000 VND</p>
              </div> 
            </div>
          </div>
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card text-center card-product">
              ...
              <div class="card-body">
                <p>Accessories</p>
                <h4 class="card-product__title"><a href="#">TWILL CAP WITH SLOGAN</a></h4>
                <p class="card-product__price">649,000 VND</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="section-margin calc-60px">
      <div class="container">
        ...
        <div class="owl-carousel owl-theme" id="bestSellerCarousel">
          <div class="card text-center card-product">
            <div class="card-product__img">
              <img class="img-fluid" src="../img/product/product9.jpg" alt="">
              <ul class="card-product__imgOverlay">
                <li><button><i class="ti-shopping-cart"></i></button></li>
                <li><button><i class="ti-heart"></i></button></li>
              </ul>
            ...
            <div class="card-body">
              <p>Accessories</p>
              <h4 class="card-product__title"><a href="single-product.php">OVAL ACETATE SUNGLASSES</a></h4>
              <p class="card-product__price">1,799,000 VND</p>
            </div>
          </div>

          <div class="card text-center card-product">
            <div class="card-product__img">
              <img class="img-fluid" src="../img/product/product10.jpg" alt="">
              <ul class="card-product__imgOverlay">
                <li><button><i class="ti-shopping-cart"></i></button></li>
                <li><button><i class="ti-heart"></i></button></li>
              </ul>
            ...
            <div class="card-body">
              <p>Man</p>
              <h4 class="card-product__title"><a href="single-product.php">LINEN/COTTON TROUSERS</a></h4>
              <p class="card-product__price">1,799,000 VND</p>
            </div>
          </div>
          ...
          <div class="card text-center card-product">
            <div class="card-product__img">
              <img class="img-fluid" src="../img/product/product11.jpg" alt="">
              <ul class="card-product__imgOverlay">
                <li><button><i class="ti-shopping-cart"></i></button></li>
                <li><button><i class="ti-heart"></i></button></li>
              </ul>
            ...
            <div class="card-body">
              <p>Woman</p>
              <h4 class="card-product__title"><a href="single-product.php">BASIC SATIN SHIRT</a></h4>
              <p class="card-product__price">799,000 VND</p>
            </div>
          </div>
          ...
          <div class="card text-center card-product">
            <div class="card-product__img">
              <img class="img-fluid" src="../img/product/product12.jpg" alt="">
              <ul class="card-product__imgOverlay">
                <li><button><i class="ti-shopping-cart"></i></button></li>
                <li><button><i class="ti-heart"></i></button></li>
              </ul>
            ...
            <div class="card-body">
              <p>Man</p>
              <h4 class="card-product__title"><a href="single-product.php">COMPACT SWEATSHIRT</a></h4>
              <p class="card-product__price">1,099,000 VND</p>
            </div>
          </div>
          ...
          <div class="card text-center card-product">
            <div class="card-product__img">
              <img class="img-fluid" src="../img/product/product5.jpg" alt="">
              <ul class="card-product__imgOverlay">
                <li><button><i class="ti-shopping-cart"></i></button></li>
                <li><button><i class="ti-heart"></i></button></li>
              </ul>
          ...
          <div class="card text-center card-product">
            <div class="card-product__img">
              <img class="img-fluid" src="../img/product/product7.jpg" alt="">
              <ul class="card-product__imgOverlay">
                <li><button><i class="ti-shopping-cart"></i></button></li>
                <li><button><i class="ti-heart"></i></button></li>
              </ul>
          ...
          <div class="card text-center card-product">
            <div class="card-product__img">
              <img class="img-fluid" src="../img/product/product3.jpg" alt="">
              <ul class="card-product__imgOverlay">
                <li><button><i class="ti-shopping-cart"></i></button></li>
                <li><button><i class="ti-heart"></i></button></li>
              </ul>
